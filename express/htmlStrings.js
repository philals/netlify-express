...
label {
  display: block;
}</style></head><body><h1>Serverless Netlify Xero SSO App</h1><img class="mountain-logo" src="/images/mountain.png"><p><a href="/login"> <img class="mountain-logo" src="/images/xero_login.png"></a></p></body></html>`
